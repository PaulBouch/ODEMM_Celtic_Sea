...
graph_obj <- function(data, InSector, InPressure, InEco, method, percent){
  ...
  # for (i in nrow(data)){if ( data[i, 8] %in% dataselected$key){
  #     obj =paste0 (obj, data[i, 7], " [penwidth = 20, color = red]; ", sep = " ")
  #     } else{obj = paste0 (obj, data[i, 7], " [penwidth = 20, color = blue];", sep = " ")}}
